      ...
      <div className="flex items-center justify-between px-4 md:px-0 md:justify-center md:gap-96 py-3 border-b">
        <div className="flex gap-10 items-center">
          <div className="flex items-center gap-4">
            <span onClick={handleNavOpen} className="md:hidden cursor-pointer p-1">
          ...
          <nav className={`absolute h-full w-full max-md:bg-[#00000066] md:static z-10 md:z-0 transition-all duration-500 top-0 ${ !isNavOpen? "-left-[1000px]" : "left-0"} md:flex`}>
            <div className="h-full w-60 max-md:bg-white">
              <div onClick={handleNavClose} className="md:hidden p-4">
                <img className="w-5 cursor-pointer" src="assets/icons/icon-close.svg" alt="close" />
              </div>
